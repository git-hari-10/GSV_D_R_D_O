...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section 
        className="relative h-screen flex items-center justify-center text-center gradient-hero"
        style={{
          backgroundImage: `linear-gradient(rgba(33, 150, 243, 0.8), rgba(63, 81, 181, 0.8)), url(${heroImage})`,
